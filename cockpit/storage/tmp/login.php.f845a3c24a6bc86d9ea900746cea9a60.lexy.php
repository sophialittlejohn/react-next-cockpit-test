...
<head>
    ...
    <style>
        ...
        .login-image {
            background-image: url(<?php echo $app->pathToUrl('assets:app/media/logo.svg'); ?>);
        ...
        <form class="uk-form" method="post" action="<?php $app->route('/auth/check'); ?>" onsubmit="{ submit }">
            ...
            <div id="login-dialog" class="login-dialog uk-panel-box uk-panel-space uk-nbfc" show="{!$user}">
                ...
                <div class="uk-form-row">
                    <input ref="user" class="uk-form-large uk-width-1-1" type="text" placeholder="<?php echo $app("i18n")->get('Username'); ?>" autofocus required>
                </div>
